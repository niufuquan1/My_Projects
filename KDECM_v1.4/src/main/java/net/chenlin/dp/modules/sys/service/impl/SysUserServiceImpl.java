...
public class SysUserServiceImpl implements SysUserService {
	...
	public SysUserEntity getUserEmail(String email) {
		return sysUserManager.getUserEmail(email);
	}
	
	public SysUserEntity getUserphone(String phone) {
		return sysUserManager.getUserphone(phone);
	}
	
	public int UpatePwdforEmail(String ValidateCode,String pwd) {
		return sysUserManager.UpatePwdforEmail(ValidateCode, pwd);
	}
	
	public int UpdatePwdforPhone(String ValidateCode,String pwd) {
		return sysUserManager.UpdatePwdforPhone(ValidateCode, pwd);
	}
	
	public R regist(SysUserEntity user) {
		int flag = sysUserManager.regist(user);
		return CommonUtils.msg(flag);
	}
}
